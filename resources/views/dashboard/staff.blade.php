<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <!-- Welcome Card -->
            <div class="bg-gradient-to-r from-blue-500 to-purple-600 dark:from-blue-700 dark:to-purple-800 overflow-hidden shadow-sm sm:rounded-lg mb-8">
                <div class="p-6 text-white">
                    <h3 class="text-xl font-semibold mb-2">Welcome back, {{ auth()->user()->name }}!</h3>
                    <p class="text-blue-100">
                        You have access to manage customers and view orders. Start by reviewing the statistics above or navigate to the customers section to add new customers.
                    </p>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                ...
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg p-6">
                    <h3 class="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-2">Add New Customer</h3>
                    <p class="text-gray-600 dark:text-gray-400 mb-4 text-sm">
                        Create a new customer record in the system.
                    </p>
                    <a 
                        href="{{ route('customers.create') }}" 
                        class="inline-block px-4 py-2 bg-green-600 hover:bg-green-700 text-white rounded-lg transition font-medium"
                    >
                        Add Customer
                    </a>
                </div>
                ...
                <!-- View Orders Card -->
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg p-6">
                    <h3 class="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-2">View Orders</h3>
                    <p class="text-gray-600 dark:text-gray-400 mb-4 text-sm">
                        Browse and manage all orders in the system.
                    </p>
                    <a 
                        href="{{ route('orders.index') }}" 
                        class="inline-block px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-lg transition font-medium"
                    >
                        View Orders
                    </a>
                </div>
